...
def brute_force_time(password):
    ...
    attempts_per_sec = 1e9  # 1 billion attempts/sec
...
def visualize_results(password):
    ...
    # Plot 2: Brute Force Time (Log Scale)
    ...
    # Plot 3: Dictionary Attack Check
